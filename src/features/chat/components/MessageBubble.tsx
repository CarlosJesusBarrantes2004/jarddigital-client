...
interface MessageBubbleProps {
  ...
  /** In audit mode for DIRECT chats, the user ID whose messages align right */
  auditPerspectiveId?: number;
  /** Callback to initiate reply to this message */
  onReply?: (message: ChatMessage) => void;
  /** Callback to scroll to a replied-to message */
  onScrollToMessage?: (messageId: number) => void;
  /** Whether the chat is read-only (audit mode or readonly) */
  isReadOnly?: boolean;
}
...
export const MessageBubble = ({
  ...
  return (
    <div
      ref={rootRef}
      className={cn("flex w-full gap-2 relative", effectiveMine ? "justify-end" : "justify-start")}
